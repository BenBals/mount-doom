...
std::optional<PartialSolution> algorithms::BranchingChallengeSolver::solve(FvsInstance &&instance) {
...
CycleCliqueVertexCoverLightlyReducingChallengeSolver::
    CycleCliqueVertexCoverLightlyReducingChallengeSolver()
    : _phase_3(std::make_unique<CycleCliqueVertexCoverSolver>()),
      _phase_2(std::make_unique<SccSplittingSolver>(_phase_3.get())),
      _phase_1(std::make_unique<LightlyReducingSolver>(_phase_2.get())) {}
std::optional<PartialSolution>
CycleCliqueVertexCoverLightlyReducingChallengeSolver::solve(FvsInstance &&instance) {
  return _phase_1->solve(std::move(instance));
}
