...
class CycleCliqueVertexCoverLightlyReducingChallengeSolver : public Solver {
  std::unique_ptr<CycleCliqueVertexCoverSolver> _phase_3;
  std::unique_ptr<SccSplittingSolver> _phase_2;
  std::unique_ptr<LightlyReducingSolver> _phase_1;

public:
  CycleCliqueVertexCoverLightlyReducingChallengeSolver();
  ~CycleCliqueVertexCoverLightlyReducingChallengeSolver() override = default;
