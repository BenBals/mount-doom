...
private:
    ...
    inline EdgeID get_first_edge(const NodeID & node_) {
        return m_nodes[node_].firstEdge;
    }

    inline EdgeID get_first_invalid_edge(const NodeID & node_) {
        return m_nodes[node_+1].firstEdge;
    }
